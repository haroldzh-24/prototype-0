...
export default function Stage25D({ stage, selectedId }: { stage: StageDocument; selectedId: string | null }) {
  ...
  return <View style={{ gap: 10 }}>
    ...
    <Image source={{ uri }} style={{ width: '100%', aspectRatio: 1.5, backgroundColor: '#edf2f5' }} contentFit="contain"
    ...
    <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8 }}>
      {[
        ...
        style={{ backgroundColor: '#33424f', padding: 10, borderRadius: 4, opacity: control.disabled ? 0.4 : 1 }}>
        <Text style={{ color: 'white' }}>{control.label}</Text>
      </Pressable>)}
    </View>
